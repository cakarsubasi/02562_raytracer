...
function build_bsp_tree(drawingInfo, device, buffers)
{
  ...
  buffers.attribs = device.createBuffer({
    size: g_drawingInfo.attribs.byteLength,
    usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.STORAGE
  });
  device.queue.writeBuffer(buffers.attribs, 0, g_drawingInfo.attribs);
...
{
  let face_x = g_drawingInfo.indices[idx*4]*8;
  let face_y = g_drawingInfo.indices[idx*4 + 1]*8;
  let face_z = g_drawingInfo.indices[idx*4 + 2]*8;
  let v0 = vec3(g_drawingInfo.attribs[face_x], g_drawingInfo.attribs[face_x + 1], g_drawingInfo.attribs[face_x + 2]);
  let v1 = vec3(g_drawingInfo.attribs[face_y], g_drawingInfo.attribs[face_y + 1], g_drawingInfo.attribs[face_y + 2]);
  let v2 = vec3(g_drawingInfo.attribs[face_z], g_drawingInfo.attribs[face_z + 1], g_drawingInfo.attribs[face_z + 2]);
